...
export default function ExploreCard({img, title, subtitle}: ExploreCardsProps){
    ...
    return(
        <section className="flex flex-col justify-start md:w-1/3 px-10 gap-3 hover:shadow-2xl hover:-translate-y-1 transition-all">
        ...
        <Link className="bg-amber-300 font-bold self-center mt-5 py-2 px-8 rounded-lg text-black hover:bg-amber-400 transition-colors" to="about">Explore</Link>
        </div>
        </section>
    )
