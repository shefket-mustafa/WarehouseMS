...
export default function Footer() {
  return (
    <>
      <main className="flex py-5 mt-10 flex-col md:flex-row items-center  md:justify-around border-slate-350 w-full md:h-45 text-xs bg-slate-900 text-white px-20 pt-2">
        {/* Navigation */}
